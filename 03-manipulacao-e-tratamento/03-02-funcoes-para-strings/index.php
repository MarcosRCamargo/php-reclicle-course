...
$mbReplace = $string . "Fui, e iria novamente.";
echo "<pre>";
echo var_dump([
...
// echo "<pre>";
echo "<p>" . $mbReplace . "</p>";
echo "<p>", str_replace("AC/DC", "Iron Mainden", $mbReplace) , "</p>";
echo "<p>", str_replace(["AC/DC", "show", "último"], "Iron Mainden", $mbReplace) , "</p>";
echo "<p>", str_replace(["AC/DC", "incrível"],["Iron Mainden", "Épico!"], $mbReplace) , "</p>";
...
$endPoint  = "name=Marcos&email=marcos@technominds.com";
